  ...
  return (
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 md:px-12 overflow-hidden">
        ...
        <p className="font-body-lg text-body-lg text-[#c7c4d7] max-w-2xl mx-auto mb-10 text-center">
          Upload a chapter, a lecture transcript, or your own notes. FymenAI
          asks you to explain it back, then maps exactly where your
          understanding holds up and where it doesn&apos;t.
        </p>
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
        ...
        <a
          href="#features"
          className="bg-white/5 border border-white/10 font-body-md px-8 py-4 rounded-lg font-bold hover:bg-white/10 transition-colors w-full md:w-auto inline-flex items-center justify-center"
        >
          See it work
        </a>
      </div>
