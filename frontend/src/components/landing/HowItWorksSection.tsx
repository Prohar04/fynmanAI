const steps = [
  {
    icon: "upload_file",
    title: "01. UPLOAD",
    description: "Add a PDF, a lecture transcript, or your own notes — or skip straight to a topic.",
  },
  {
    icon: "settings_input_component",
    title: "02. SET SCOPE",
    description:
      "Tell it what you're studying. Subject and topic shape the questions it asks.",
  },
  {
    icon: "hub",
    title: "03. EXPLAIN IT BACK",
    description:
      "It asks Feynman-style questions and checks your answer against the source material.",
  },
  {
    icon: "layers",
    title: "04. GAPS SURFACE",
    description:
      "Every session adds to your knowledge graph, so weak spots show up before the exam does.",
  },
];
      ...
      <div className="px-4 md:px-12 max-w-360 mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="font-body-lg text-body-lg text-[#c7c4d7]">
            From raw material to a knowledge graph, in four steps.
          </p>
        </div>
