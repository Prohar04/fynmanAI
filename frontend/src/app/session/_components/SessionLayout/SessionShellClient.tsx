  ...
  return (
    <div
      className={`flex flex-col h-screen overflow-hidden text-on-background ${
        isActiveSession ? "bg-background" : "bg-surface-container-lowest"
      ...
      <MobileNav
        leftItems={[
          ...
          isActiveSession
            ...
            : { icon: "keyboard", label: "Type", onPress: () => {}, disabled: true },
        ]}
        centerButton={
          isActiveSession
            ? {
        ...
        rightItems={[
          isActiveSession
            ...
            : { icon: "stop_circle", label: "Stop", onPress: () => {}, disabled: true },
